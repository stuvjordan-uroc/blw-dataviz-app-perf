...
import type { ImpViz, Layout, Out, PointsMap, SegmentViews, Segment, SegmentGroupedViews } from './functions-and-types/types.ts';
...
if (data) {
  ...
  //console.log(util.inspect(out.imp.gov_stats?.viz.small?.segments, true, 3, true))
